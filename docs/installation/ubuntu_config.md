...
You can now return to where you left off in the main SecureDrop install guide [by clicking here](installation/install.md#install-the-securedrop-application).
